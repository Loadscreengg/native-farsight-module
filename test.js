// this file is a copy of index.js, but uses local offsets instead of the ones in the repo, so we can test things locally.
// running this with node test.js will also connect to league and log data to the console
...
var localOffsets = require(`./offsets/offsets-14.7.1.json`);
